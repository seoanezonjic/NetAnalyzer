...
@pytest.mark.parametrize("args", [
    ( "-i graphA,{net1}.npy;graphB,{net2}.npy -n graphA,{net1}.lst;graphB,{net2}.lst -f bin --neigh_level graphA,0;graphB,0 -N --seed_nodes {seeds} -g {output_file} --embedding_proj umap --compare_nets")
])
